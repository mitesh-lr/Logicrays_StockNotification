...
namespace Logicrays\StockNotification\Unit\Test\Controller\Adminhtml\StockNotification;

use Magento\Backend\App\Action\Context;
use Magento\Framework\View\Result\PageFactory;
use Magento\Framework\TestFramework\Unit\Helper\ObjectManager;
use Logicrays\StockNotification\Controller\Adminhtml\StockNotification\Index;
use Magento\Framework\Authorization;
use PHPUnit\Framework\TestCase;

/**
 * Unit test for stock notification grid render file.
 */
class IndexTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->pageFactory = $this->getMockBuilder(PageFactory::class)
            ...
            ->getMock();
        $this->stocknotification = new Index(
            $this->context,
            $this->pageFactory
        );
    }
